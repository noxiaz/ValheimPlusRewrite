...
namespace ValheimPlusRewrite.Configurations.Sections
{
    public class ExperienceConfiguration : ServerSyncConfig
    {
		...
		[Description("The modifier value for the experience gained of FireMagic.")]
		public ConfigModel<float> FireMagic { get; internal set; } = 0;
		[Description("The modifier value for the experience gained of FrostMagic.")]
		...
		[Description("The modifier value for the experience gained of WoodCutting.")]
