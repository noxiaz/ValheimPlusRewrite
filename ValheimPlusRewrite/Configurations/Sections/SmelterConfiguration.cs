...
namespace ValheimPlusRewrite.Configurations.Sections
{
    ...
    {
        [ConfigDescription("Maximum amount of ore in a Smelter.")]
        public ConfigModel<int> MaximumOre { get; internal set; } = 10;
        [ConfigDescription("Maximum amount of coal in a Smelter.")]
        ...
        [ConfigDescription("The time it takes for the Smelter to produce a single ingot in seconds.")]
        ...
        [ConfigDescription("The Smelter will pull coal and raw materials from nearby chests to be automatically added to it when its empty.")]
        public ConfigModel<bool> AutoFuel { get; internal set; } = false;
        [ConfigDescription("This option prevents the Smelter to pull items from warded areas if it isn't placed inside of it.")]
