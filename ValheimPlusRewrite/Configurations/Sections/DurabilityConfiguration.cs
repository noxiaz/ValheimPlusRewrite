...
namespace ValheimPlusRewrite.Configurations.Sections
{
    ...
    {
        [Description("Each of these values increase or reduce the durability of the specific item type by %. - The value 50 will increase the durability from 100 to 150. The value -50 will reduce the durability from 100 to 50.")]
